namespace HSDRaw.Melee.Pl
{
    ...
    public class SBM_DynamicParams : HSDAccessor
    {
        ...
        public float RotX { get => _s.GetFloat(0x08); set => _s.SetFloat(0x08, value); }
        public float RotY { get => _s.GetFloat(0x0C); set => _s.SetFloat(0x0C, value); }
        public float RotZ { get => _s.GetFloat(0x10); set => _s.SetFloat(0x10, value); }
        public float RotW { get => _s.GetFloat(0x14); set => _s.SetFloat(0x14, value); }
        public float RotLimit { get => _s.GetFloat(0x18); set => _s.SetFloat(0x18, value); }
        ...
        public float RotMomentumSpeed { get => _s.GetFloat(0x34); set => _s.SetFloat(0x34, value); }
        public float MaxAngleChange { get => _s.GetFloat(0x38); set => _s.SetFloat(0x38, value); }
    }
}
