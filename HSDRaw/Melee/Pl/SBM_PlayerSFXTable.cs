namespace HSDRaw.Melee.Pl
{
    public class SBM_PlayerSFXTable : HSDAccessor
    {
        ...
        public int SFX_Hurt { get => _s.GetInt32(0x04); set => _s.SetInt32(0x04, value); }

        public int SFX_Unknown1 { get => _s.GetInt32(0x08); set => _s.SetInt32(0x08, value); }

        public int SFX_StarKO { get => _s.GetInt32(0x0C); set => _s.SetInt32(0x0C, value); }

        public int SFX_Unknown2 { get => _s.GetInt32(0x10); set => _s.SetInt32(0x10, value); }

        public int SFX_LedgeGrab { get => _s.GetInt32(0x14); set => _s.SetInt32(0x14, value); }

        public int SFX_AirDodge { get => _s.GetInt32(0x18); set => _s.SetInt32(0x18, value); }
        ...
        public int SFX_Unknown3 { get => _s.GetInt32(0x24); set => _s.SetInt32(0x24, value); }

        public int SFX_LedgeTotter { get => _s.GetInt32(0x28); set => _s.SetInt32(0x28, value); }

        public int SFX_HeavyLift { get => _s.GetInt32(0x2C); set => _s.SetInt32(0x2C, value); }

        public int SFX_Step { get => _s.GetInt32(0x30); set => _s.SetInt32(0x30, value); }
