namespace HSDRaw.AirRide.Gr.Data
{
    public class KAR_grPositionList : HSDAccessor
    {
        ...
        public HSDArrayAccessor<KAR_grPositionData> PositionData 
        { 
            get => _s.GetReference<HSDArrayAccessor<KAR_grPositionData>>(0x04);
    ...
    public class KAR_grPositionData : HSDAccessor
    {
        ...
        public float FX { get => _s.GetFloat(0x0C); set => _s.SetFloat(0x0C, value); }

        public float FY { get => _s.GetFloat(0x10); set => _s.SetFloat(0x10, value); }

        public float FZ { get => _s.GetFloat(0x14); set => _s.SetFloat(0x14, value); }

        public float UX { get => _s.GetFloat(0x18); set => _s.SetFloat(0x18, value); }

        public float UY { get => _s.GetFloat(0x1C); set => _s.SetFloat(0x1C, value); }

        public float UZ { get => _s.GetFloat(0x20); set => _s.SetFloat(0x20, value); }
    }
}
