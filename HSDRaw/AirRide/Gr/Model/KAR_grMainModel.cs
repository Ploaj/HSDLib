...
namespace HSDRaw.AirRide.Gr
{
    public class KAR_grMainModel : HSDAccessor
    {
        ...
        public int JobjCount { get => _s.GetInt32(0x04); set => _s.SetInt32(0x04, value); }

        public int DobjCount { get => _s.GetInt32(0x08); set => _s.SetInt32(0x08, value); }

        public int PobjCount { get => _s.GetInt32(0x0C); set => _s.SetInt32(0x0C, value); }
