...
{
    public class KAR_vcDataWheel : HSDAccessor
    {
        ...
        public KAR_vcAnimationWheel AnimationBank { get => _s.GetReference<KAR_vcAnimationWheel>(0x18); set => _s.SetReference(0x18, value); }
    }
}
