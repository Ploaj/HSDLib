...
namespace HSDRaw.MEX
{
    public class MEX_BGMStruct : HSDAccessor
    {
        ...
        public HSDFixedLengthPointerArrayAccessor<HSD_String> BackgroundMusicNames { get => _s.GetReference<HSDFixedLengthPointerArrayAccessor<HSD_String>>(0x0C); set => _s.SetReference(0x0C, value); }
