...
namespace HSDRaw.MEX
{
    public class MEX_SSMTable : HSDAccessor
    {
        ...
        public HSDArrayAccessor<MEX_SSMSizeAndFlags> SSM_BufferSizes { get => _s.GetReference<HSDArrayAccessor<MEX_SSMSizeAndFlags>>(0x04); set => _s.SetReference(0x04, value); }
