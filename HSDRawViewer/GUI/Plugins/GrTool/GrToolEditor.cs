...
namespace HSDRawViewer.GUI.Plugins.AirRide.GrTool
{
    ...
    public partial class GrToolEditor : PluginBase, IDrawableInterface
    {
        ...
        private void seekStartToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _render.Frame = 0;
        }

        private void seekEndToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _render.Frame = _render.FrameCount;
        }

        private void drawArcToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _render.DrawAnimationArc = drawArcToolStripMenuItem.Checked;
        }
    }
}
