...
namespace HSDRawViewer.Converters
{
    public class DAEWriter : IDisposable
    {
        ...
        private Dictionary<string, Tuple<List<List<int>>, List<List<float>>>> GeometryControllers = new Dictionary<string, Tuple<List<List<int>>, List<List<float>>>>();
        ...
        public void AttachGeometryController(List<List<int>> BoneIndices, List<List<float>> Weights)
        {
            GeometryControllers.Add(CurrentGeometryID, new Tuple<List<List<int>>, List<List<float>>>(BoneIndices, Weights));
        }
        ...
        public void WriteLibraryController(string Name)
        {
            ...
            writer.WriteAttributeString("source", $"#{Name}");
            {
                ...
                //v
                {
                    ...
                    {
                        for (int j = 0; j < BoneWeight.Item1[i].Count; j++)
                        {
