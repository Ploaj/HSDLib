    ...
    public class PhysicsSimulator
    {
        ...
        public class PhysicsJobj
        {
            ...
            public Matrix4 LocalMatrix
                ...
                Math3D.CreateMatrix4FromEuler(Rotation.X, Rotation.Y, Rotation.Z) *
        ...
        public class Dynamics
        {
            ...
            public void Think(JOBJManager m, List<SBM_DynamicHitBubble> hitbubbles, bool enable_ground_collision, int max_apply_physics, int air_state)
            {
                ...
                var matrix = m.GetWorldTransform(m.GetJOBJ(m.ParentIndex(dynamic_params.Joint.Jobj)));
                ...
                for (int i = 0; i < PhysicsBones.Count - 1; i++)
                {
                    ...
                    if (i < ApplyNum)
                        m.ClearOverrideLocalTransform(v.Joint.Jobj);
                    else
                        m.SetOverrideLocalTransform(v.Joint.Jobj, v.Joint.LocalMatrix);
                }
            }
        }
